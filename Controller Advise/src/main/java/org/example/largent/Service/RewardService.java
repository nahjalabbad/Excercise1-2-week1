...
public class RewardService {
    ...
    public List<Reward> getByExpiration(String status) {
        ...
        for (Reward reward : allRewards) {
            ...
            if (expireDate != null&&reward.getStatus().equals(status)) {
            ...
            if (!reward.getStatus().equals(status)){
                throw new ApiException("please enter a valid status such as expired or not expired");
            }
        }
