...
public class MerchantStockController {
    ...
    @PutMapping("/addstock/{merchentStockID}/{amount}")
    public ResponseEntity addStock(@PathVariable Integer merchentStockID, @PathVariable int amount) {
        boolean addStock = merchantStockService.addStock(merchentStockID,amount);
        if (addStock) {
